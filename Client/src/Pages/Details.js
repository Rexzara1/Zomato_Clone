...
class Details extends React.Component{
    ...
    componentDidMount(){
        ...
        .then(res => {
            this.setState({ restaurant: res.data.restaurants, resId: restuarant })  // set.State is used to update(edit/change) the data in this.state
        })
    ...
    render(){
        const { restaurant, galleryModal, menuModal, menu, subtotal, formModal } = this.state; // calling of the state.
                    ...
                    <div className="tabs">
                        <div className="tab">
                            ...
                            <div className="content">
                                ...
                                <div className="value">₹{restaurant.cost} for two peole(approx.)</div>
                            </div>
                        </div>
                ...
                <Modal
                    ...
                    { menu?.map((item, index) => {
                                ...
                                <div className="menu_image">
...

                                    {
                                        item.qty == 0 ? <div className="item_quantity_button" onClick={() => this.addItems(index, 'add')}>
                                            ADD
                                        </div> : <div className="item_quantity_button">
                        ...
                        <div className="payment">
                            ...
                            <button className="btn btn-danger order_but" onClick={() => {this.handleModal('menuModal', false); this.handleModal('formModal', true);}}>
                                Pay Now
                            </button>
                        </div>
                    </div>
